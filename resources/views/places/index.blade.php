...
<div class="row breadcumb">
    ...
    <div class="d-flex align-items-center agregar">
        <a id="create-activity" class="create-activity" href="{{ route('create-place') }}">
            Agregar
                    ...
                    @foreach ($places as $item)
                        <li>
                            <div class="row">
                                ...
                                <a class="d-flex align-items-center name" href="{{ route('place',$item->id)}}">
                                    {{$item->name}}
                                </a>
                                <div class="d-flex align-items-center botones">
                                    <a href="/home/edit-place/{{$item->id}}" class="boton">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <i onclick="eliminar({{$item->id}})" class="fa fa-trash boton"
                                    style="position: relative; top: -1.5px;"></i>
                                    <a href="{{ route('place',$item->id)}}" class="boton">
