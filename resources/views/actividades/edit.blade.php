    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- rduarte, formulario para actulizar la actividad -->
                    <form method="POST" class="" action="{{ route('update-activity') }}" id="update_activity" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group mb-3">
                            <input type="hidden" name="id" value="{{$activity->id}}">
                            <input type="text" class="form-control" placeholder="Nombre" aria-label="Username" id="activity-name" name="name" aria-describedby="basic-addon1" value="{{$activity->name}}" required>
                        </div>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Descripción" aria-label="Username" id="activity-description" name="description" aria-describedby="basic-addon1" value="{{$activity->description}}" required>
                        </div>

                        <div class="input-group mb-3">
                            <input type="hidden" name="activity_icon_actualy" value="{{$activity->icon}}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" id="activity-dificulty" name="dificulty" min="1" max="5" placeholder="Dificultad" value="{{$activity->dificulty}}" required>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <!-- Datos del origin -->
                        <input type="hidden" name="id_origin" value="{{$point_a->id}}">
                        ...
                        <input type="hidden" name="id_destination" value="{{$point_b->id}}">
...
<script>
    ...
    async function categoriesList() {
        var id_category = "{{$activity->id_category}}";
        ...
        await jQuery.ajax( {
            ...
            success: function( data ) {
                data.forEach( function(value, index) {
                    var selected = '';
                    if(id_category == data[index].id){
                        selected = 'selected';
                    } else {
                        selected = '';
                    }
                    var category = `<option value="`+data[index].id+`" `+selected+`>`+data[index].name+`</option>`;
