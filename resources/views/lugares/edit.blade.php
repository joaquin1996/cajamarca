            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Nombre" aria-label="Username" id="activity-name" aria-describedby="basic-addon1" value="{{$activity->name}}">
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Descripción" aria-label="Username" id="activity-description" aria-describedby="basic-addon1" value="{{$activity->description}}">
                    </div>

                    <div class="input-group mb-3">
                        <input id="activity-icon-actualy" type="hidden" value="{{$activity->icon}}">
                    ...
                    <div class="col-auto">
                        ...
                        <input type="number" class="form-control" id="activity-dificulty" placeholder="Password" value="{{$activity->dificulty}}">
                      </div>
...
<script>
    $(document).ready( async function(){
        ...
        await $('#save-activity').on('click', function(e){
            ...
            e.preventDefault();
            var id = "{{$activity->id}}"
            var id_origin = "{{$point_a->id}}"
            var id_destination = "{{$point_b->id}}"
            ...
            var activity_icon_actualy = $('#activity-icon-actualy').val();
                                                    ...
                                                    if(data_destination.elevation != null && data_destination.elevation != undefined) {
                                                        if(data_origin.description != null && data_origin.description != undefined) {
                                                            if(data_destination.temp != '' && data_destination.temp != null && data_destination.temp != undefined) {
                                                                ...
                                                                data.append('id',id);
                                                                data.append('id_origin',id_origin);
                                                                data.append('id_destination',id_destination);
                                                                data.append('activity_icon_actualy',activity_icon_actualy);
